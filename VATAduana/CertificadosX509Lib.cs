...
namespace VATAduana
{
    class CertificadosX509Lib
    {
        ...
        /// <remarks></remarks> 
        public static X509Certificate2 ObtieneCertificadoDesdeArchivo(string argArchivo, string pass)
        {
            

            try
            {
                X509Certificate2 objCert = new X509Certificate2(argArchivo, pass);
                return objCert;
            }
